...
export default function ProgressBar(){
  ...
  return (
    <div
      className="fixed top-0 left-0 h-3  w-full bg-gradient-to-r from-pink-600 via-purple-600 to-emerald-400 transition-width duration-300 ease-in-out opacity-0 flex items-center"
      style={{

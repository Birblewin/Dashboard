  ...
  return (
    <div className='relative h-screen overflow-hidden'>
      ...
      <div className='relative overflow-hidden h-screen flex justify-center items-center z-1'>
        <img
          loading="lazy"
          className="absolute bottom-[-57%] mt-[-30%] transform -translate-y-24 mx-auto transition-transform md:translate-y-0 md:mt[-18%]"
          style={{ color: "transparent", zIndex: 1, maxWidth: '65vw' }}
          src="/Big Planet.png"
          alt="Big Planet"
        />
      </div>
      ...
      <div className="absolute inset-0  flex mx-auto items-center justify-center z-1"> 
        <h1 className='text-white pointer-events-none text-3xl md:text-center' style={{ marginTop: '-8%', marginBottom: '20%', zIndex: 2 }}>Page Not Found</h1>
      </div>

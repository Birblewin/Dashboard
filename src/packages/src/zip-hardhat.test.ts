...
import type { Contractt } from './contract';
...
async function runTest(c: Contractt, t: ExecutionContext<Context>, opts: GenericOptions) {
...
function assertLayout(zip: JSZip, c: Contractt, t: ExecutionContext<Context>) {
...
async function extractAndRunPackage(zip: JSZip, c: Contractt, t: ExecutionContext<Context>) {
...
async function assertContents(zip: JSZip, c: Contractt, t: ExecutionContext<Context>) {

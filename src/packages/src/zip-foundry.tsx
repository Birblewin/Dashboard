...
// import Initialcode from "@/store/Defaultcode";
...
// export async function zipFoundry(c: Contractt, opts?: GenericOptions) {
//   const zip = new JSZip();
//   const initialCodeContent = ReactDOMServer.renderToStaticMarkup(<Initialcode />);

//   zip.file(`src/${c.name}.sol`, initialCodeContent);

      ...
      <div>
        ...
        <div className="flex flex-row">
            <div className="flex flex-col w-[60%] p-[0.5rem]">
                <label htmlFor="name" className="text-[0.875rem]  text-white">
                    Name
                </label>
                <input  id="name" type="text" placeholder="MyToken" className="border border-[0.5px] border-[#818998] bg-transparent rounded-[6px] p-1 " value={name}  onChange={(e) => setName(e.target.value)}/>
            </div>
            <div className="flex flex-col w-[40%] p-[0.5rem]">
                <label htmlFor="symbol" className="text-white text-[0.875rem]">
                    Symbol
                </label>
                <input  id="symbol" type="text" placeholder="MTK" className="border border-[0.5px] border-[#818998] bg-transparent rounded-[6px] p-1" value={symbol}  onChange={(e) => setSymbol(e.target.value)}/>
            </div>
        </div>
        <div className="flex flex-col p-[0.5rem]">
            ...
            <input  id="uri" type="string" placeholder="0" className={`border rounded-[6px] p-1 text-black border-[0.5px] border-[#818998] bg-transparent`} value={premint}   onChange={ handlePremintChange}/>
        </div>
        </div>
      ...
      <div className="mt-2">
        <label className={`flex items-center justify-between cursor-pointer ${mintable ? 'bg-[#bdaaec]' : ''}`}>
          <div className="m-[0.5rem] flex items-center">
            ...
            />
            <span className={`ml-[0.5rem] select-text text-white `}>Mintable</span>
          </div>
        ...
        <label className={`flex items-center justify-between cursor-pointer ${burnable ? 'bg-[#4D3C77]' : ''}`}>
          <div className="m-[0.5rem] flex items-center">
            ...
            />
            <span className={`ml-[0.5rem] select-text text-white`}>Burnable</span>
          </div>
        ...
        <label className={`flex items-center justify-between cursor-pointer ${pauseable ? 'bg-[#4D3C77]' : ''}`}>
          <div className="m-[0.5rem] flex items-center">
            ...
            />
            <span className={`ml-[0.5rem] select-text text-white`}>Pauseable</span>
          </div>
        ...
        <label className={`flex items-center justify-between cursor-pointer ${permit ? 'bg-[#4D3C77]' : ''}`}>
          <div className="m-[0.5rem] flex items-center">
            <input
            ...
            />
            <span className={`ml-[0.5rem] select-text text-white`}>Permit</span>
          </div>
        ...
        <label className={`flex items-center justify-between cursor-pointer ${votes ? 'bg-[#4D3C77]' : ''}`}>
          <div className="m-[0.5rem] flex items-center">
            ...
            />
            <span className={`ml-[0.5rem] select-text text-white`}>Votes</span>
          </div>
          <Tool tooltipText="Keeps track of historical balances for voting in on-chain governance, with a way to delegate one's voting power to a trusted account." link='https://docs.openzeppelin.com/contracts/5.x/api/token/erc20#ERC20Votes' linktext='Read more'/>
        </label>

        <label className={`flex items-center justify-between cursor-pointer ${flashMinting ? 'bg-[#4D3C77]' : ''}`}>
          <div className="m-[0.5rem] flex items-center">
            <input
              title="Updateable URI"
              type="checkbox"
            ...
            />
            <span className={`ml-[0.5rem] select-text text-white `}>Flash Minting</span>
          </div>
      ...
      <div className="px-2">
        ...
        <div className="flex flex-col mt-[0.75rem]">
          ...
          <input
            ...
            className="border border-[0.5px] border-[#818998] bg-transparent rounded-[6px] p-1"

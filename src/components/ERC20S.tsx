...
const ERC20 = ()=>{
    ...
    // A FUNCTION TO HANDLE THE PERMIT FUNCTIONABILITY
    function handlePermit(value: string): void{
      ...
      <div className="p-4 overflow-visible">
        <div>
          ...
          <div className="flex flex-row">
            <div className="flex flex-col w-[60%] p-[0.5rem]">
              ...
              <input
                ...
                className="border border-1 border-[#333333] rounded-[6px] p-1"
                value={name}
          ...
          <div className="flex flex-col p-[0.5rem]">
            ...
            <input
              ...
              type="string"
              placeholder="0"
              className={`border border-1 rounded-[6px] p-1 text-black border-[#333333]`}
              value={premint}
              onChange={(e) => handlePermit(e.target.value)}
            />

            {errors.premint && (
              <p className="text-sm text-red-500">{errors.premint}</p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="m-[0.5rem] flex items-center place-content-between">
            ...
            <Tool
              tooltipText="Token holders will be able to destroy their tokens."
              link="https://docs.openzeppelin.com/contracts/5.x/api/token/erc20#ERC20Burnable"
              linktext="Read more"
            />
          </div>
          <div className="m-[0.5rem] flex items-center place-content-between">
            ...
            <Tool
              tooltipText="Privileged accounts will be able to pause the functionality marked as whenNotPaused. Useful for emergency response."
              link="https://docs.openzeppelin.com/contracts/5.x/api/utils#Pausable"
              linktext="Read more"
            />
          </div>
          <div className="m-[0.5rem] flex items-center place-content-between">
            ...
            <Tool
              tooltipText="Keeps track of historical balances for voting in on-chain governance, with a way to delegate one's voting power to a trusted account."
          ...
          <div className="m-[0.5rem] mb-0 flex items-center place-content-between">
            ...
            <Tool
              tooltipText="Built-in flash loans. Lend tokens without requiring collateral as long as they're returned in the same transaction."
              link="https://docs.openzeppelin.com/contracts/5.x/api/token/erc20#ERC20FlashMint"
              linktext="Read more"
            />
          </div>
        </div>
        ...
        <div>
          <div className=" mt-0  flex items-center place-content-between mr-[0.5rem]">
            ...
            <Tool
              tooltipText="Restrict who can access the functions of a contract or when they can do it."
              link="https://docs.openzeppelin.com/contracts/5.x/api/access"
              linktext="Read more"
            />
          </div>
          <div className="m-[0.5rem]  flex items-center place-content-between">
            ...
            <Tool
              tooltipText="Simple mechanism with a single account authorized for all privileged actions."
              link="https://docs.openzeppelin.com/contracts/5.x/api/access#Ownable"
              linktext="Read more"
            />
          </div>
          <div className="m-[0.5rem]  flex items-center place-content-between">
            ...
            <Tool
              tooltipText="Flexible mechanism with a separate role for each privileged action. A role can have many authorized accounts."
              link="https://docs.openzeppelin.com/contracts/5.x/api/access#AccessControl"
              linktext="Read more"
            />
          </div>
          <div className=" flex items-center m-[0.5rem]  mb-0 place-content-between">
            ...
            <Tool
              tooltipText="Enables a central contract to define a policy that allows certain callers to access certain functions."
              link="https://docs.openzeppelin.com/contracts/5.x/api/access#AccessManag"
              linktext="Read more"
            />
          </div>
        </div>

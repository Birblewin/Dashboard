...
const CodeEditor: React.FC = () => {
  ...
  let CairoInitialCode = ERC20CInitialCode;
      ...
      function injectHyperlinks(code: string) {
        ...
        return code.replace(importRegex, `&quot;<a class="import-link" href="https://github.com/OpenZeppelin/openzeppelin-$2blob/v5.0.2/contracts/$3" target="_blank" rel="noopener noreferrer">$1$2$3</a>&quot;`);
      }

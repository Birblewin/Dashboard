    ...
    return(    
        <div className="w-[100vw] bg-cover bg-center  bg-[url('/background.png')] mix-blend-screen bg-scroll h-[450vh] "> 
                ...
                <div className="flex lg:flex-row flex-col  h-[100vh] w-[100%] md:mt-0">
                    <div className="grid grid-rows-1 lg:justify-items-start lg:w-[60%] h-[50%] mx-auto">  
                        <div  className="grid lg:grid-cols-[8%_1fr] grid-cols-[10%_1fr] items-center mx-auto lg:pt-48">            
                            <p className="mr-1 font-bold lg:text-2xl text-xl m-0 p-0 animate-pulse rotate-180 bg-clip-text text-transparent  [writing-mode:vertical-rl] bg-gradient-to-b  from-pink-500 from-26%  via-violet-500 via-25%  to-emerald-300 to-60%">OurStatus</p>
                    ...
                    <div className="mt-12 bg-white w-[2px] lg:block hidden h-[90vh]"></div>

                    <div className="lg:relative mt-10 lg:w-[40%] lg:h-[100vh] w-[100%]">
                        <Image src="/austronaut1.png" alt="austronaut"  className="lg:absolute lg:-left-12 lg:inline hidden w-[70%] h-[70%] z-10"/>
            ...
            <div>
                ...
                <div className='lg:block hidden mt-[-750px]'>
                    <div className="pl-2 pt-0 text-[400px] font-bold text-white text-opacity-100 mix-blend-overlay text-center whitespace-nowrap hidden lg:block lg:-translate-x-32 translate-y-[900px]">Q1</div>                            
                    <div><Image src="/fighter-jet.png" alt="plane image" className=" hidden lg:inline z-[51] w-3/4 translate-y-64 lg:-translate-x-[35%]"/></div>
                </div>
                ...
                <div className="lg:gap-8">
                    ...
                    <div className='lg:inline hidden lg:mt-[-200px] z-[60]'>
                        <div className="pl-2 pt-0 text-[400px] font-bold text-white text-opacity-100 mix-blend-overlay text-center whitespace-nowrap hidden lg:block lg:translate-x-96">Q2</div>                            
                        <Image src="/left-jet.png" alt="2023" className="translate-x-[80%] lg: z-[60]  w-[55%] "/>
                    </div>
                    ...
                    <div className="pl-2 pt-0 text-[400px] font-bold mt-[-600px] text-white text-opacity-30 mix-blend-overlay text-center whitespace-nowrap hidden lg:block lg:-translate-x-96 translate-y-64">Q3</div>                           
                    <div className="grid lg:grid-cols-2 lg:grid-rows-2 lg:mt-64 grid-flow-col lg:gap-10 lg:w-2/3 mx-auto z-[62]">
                        ...
                        <div className="mt-52 lg:mt-10 mx-auto card text-sm hover:p-2  backdrop-blur-sm h-min  z-10  rounded-[30px]  hover:bg-opacity-70 hover:bg-gradient-to-br from-slate-800 to-slate-800/[0.2] lg:translate-y-60" >
                            <div className='border-2  border-[#B793FF] transition-all duration-50 hover:border-slate-700  bg-opacity-40 hover:bg-opacity-70 bg-gradient-to-br from-slate-800 to-slate-800/[0.2] lg:w-[350px]  w-[300px]  rounded-[30px] px-10'>                                                       
                    ...
                    <div className='flex mx-auto lg:w-2/3 items-center'> 
                        <div className='w-[300px] hidden lg:block -translate-x-32'><Image src="/white-satellite.png" loading="lazy"  alt="2023"  /></div>
                        <div className="mt-10 mx-auto card text-sm hover:p-2  backdrop-blur-sm h-min  z-10  rounded-[30px]  hover:bg-opacity-70 hover:bg-gradient-to-br from-slate-800 to-slate-800/[0.2] " >
                            <div className='border-2 border-[#B793FF] transition-all duration-50 hover:border-slate-700  bg-opacity-40 hover:bg-opacity-70 bg-gradient-to-br from-slate-800 to-slate-800/[0.2] lg:w-[350px]  w-[300px]  rounded-[30px] px-10'>                                                                                                          
                                <p className="text-md mt-10 font-bold text-[#B793FF]">2023/Q4</p>
                ...
                <div className="  lg:inline hidden "><Image src="/forward-jet.png" alt="2023" loading="lazy" className="w-[60%]  lg:translate-x-[70%] lg:-translate-y-[100px]" /></div>
            </div>       
            </div>
            </div>
                ...
                <div>
                    <div>
                        <div>
                            ...
                            <div className='grid lg:grid-cols-3 lg:grid-rows-1 grid-flow-col flex-col lg:mt-[-150px] w-[85%] mx-auto'>
                                ...
                                <Image src="/bot.png" alt="2023" loading="lazy" width={450} className='hidden lg:block -translate-y-48'/>
                            ...
                            <div className='grid lg:grid-cols-2 lg:grid-rows-1 lg:block lg:mt-[-350px]'>
                                ...
                                <Image src="/slim-jet.png" alt="2023" loading="lazy" width={700} className='ml-auto -translate-y-52' />
                            </div>
                            <div className='grid lg:grid-cols-2 lg:grid-rows-2 grid-flow-col lg:w-[70%] lg:mt-[-250px] mx-auto'>
                            ...
                            <div className='lg:block hidden'>
                                <div className='translate-x-32 z-[60]'><Image src="/jet1.png" alt="2023" loading="lazy" className='w-[120%] '/></div>
                        ...
                        <div className='lg:flex hidden lg:mt-[-180px]'>
                            <div className="pl-2 pt-0 text-[400px] font-bold text-white text-opacity-100 mix-blend-overlay text-center whitespace-nowrap lg:-translate-x-40 hidden lg:block ">Q3</div>                           
                            <div className='w-[550px] lg:-translate-y-40'><Image src="/sideways-jet.png" loading="lazy" alt="2023"  /></div>
                        </div>
                        ...
                        <div  className="grid lg:grid-cols-2 grid-flow-col gap-10 lg:w-2/3 mx-auto ">
                            <Image src="/sat.png" alt="2023" loading="lazy" width={500} className='lg:block hidden lg:-translate-y-40'/>
                            ...
                            <div className="pl-2 pt-0 text-[400px] font-bold text-white text-opacity-100 mix-blend-overlay text-center whitespace-nowrap lg:translate-x-32 lg:-translate-y-32 hidden lg:block ">Q4</div>                            
                        </div>
                    </div>
                </div>
            </div>
